...
oc new-app -f ../templates/template-jenkins.yaml -p MEMORY_LIMIT=2Gi --p VOLUME_CAPACITY=4Gi -n ${GUID}-jenkins
...
oc new-app -f ../templates/template-jenkinsmavenslave.yaml -p GUID=${GUID}
